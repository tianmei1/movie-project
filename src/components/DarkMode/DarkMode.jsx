  ...
  return (
    <div className='dark_mode'>
      ...
      <label className='dark_mode_label' htmlFor='darkmode-toggle'>
        <svg className="sun_icon" viewBox="0 0 496 496" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className="moon_icon" viewBox="0 0 49.739 49.739" fill="none" xmlns="http://www.w3.org/2000/svg">
